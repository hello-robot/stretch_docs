...
This quick start guide provides a high level introduction to the Robot API and how to program the Stretch robot using its low level Python interface.
